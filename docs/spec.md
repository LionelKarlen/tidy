...
- Should be able to display all Items
    ...
    - with a filter function for:
        ...
        - location
        - designation
        (I'm not sure how this is going to work, since there are potentially many entries {maybe something like the twitch.tv radio button dropdown?})
...
- There will be no mobile app, but the qr codes will simply link to the right url, making them accessible from mobile
...
## Logo
Pure text logo using the "[Caveat](https://fonts.google.com/specimen/Caveat?preview=tidy)" font in regular 400.

## Icons
[Feather Icons](https://feathericons.com), using the [solid-icons](https://github.com/x64Bits/solid-icons) package.
